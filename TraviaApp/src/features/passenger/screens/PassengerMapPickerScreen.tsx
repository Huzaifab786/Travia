...
import { reverseGeocodeApi } from "../../driver/api/placeApi";
import { PassengerStackParamList } from "../navigation/PassengerNavigator";
import { useTheme } from "../../../app/providers/ThemeProvider";
import { radius, spacing, typography } from "../../../config/theme";

type PassengerMapPickerNavProp = NativeStackNavigationProp<
  PassengerStackParamList,
  "PassengerMapPicker"
>;
type PassengerMapPickerRouteProp = RouteProp<
  PassengerStackParamList,
  "PassengerMapPicker"
>;

export function PassengerMapPickerScreen() {
